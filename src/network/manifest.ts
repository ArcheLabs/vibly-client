...
export function manifestToProfileNetwork(manifest: NetworkManifest): NetworkProfile {
  ...
  return {
    ...
    relayGenesisHash: manifest.chains.payment.genesisHash,
    relayRpcUrl: manifest.chains.payment.rpcUrls[0],
    relayRpcUrls: manifest.chains.payment.rpcUrls,
    relayTokenSymbol: manifest.chains.payment.tokenSymbol,
    relayTokenDecimals: manifest.chains.payment.tokenDecimals,
